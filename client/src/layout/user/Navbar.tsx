...
const Navbar: React.FC = () => {
  ...
  if (user?.role === "agent")
    navItems.push({ name: "Agent Dashboard", path: "/dashboard/agent" });
        ...
        {user ? (
          <>
            ...
            >
              ...
              >
                {user.role === "admin" ? "Administrator" : user.role === "agent" ? "Check-In Agent" : "User"}
              </Typography>
            </Box>
          ...
          <>
            ...
            <Button
              fullWidth
              variant="outlined"
              sx={{ borderColor: "#FFD700", color: "#FFD700", mb: 1 }}
              onClick={() => {
                setDrawerOpen(false);
              ...
              {user ? (
                <>
                  ...
                  <Typography sx={{ color: "#FFD700", fontWeight: 600 }}>
                    {user.role === "admin" ? "Admin" : user.role === "agent" ? "Agent" : "User"} {displayedName}
                  </Typography>
