...
// import { fetchFlights } from "../hooks/redux/slices/flightSlice"; // Removed
...
const Flights: React.FC = () => {
  ...
  // Use React Query for fetching flights
  const { data: flights = [], isLoading: loading } = useFlights();

  // REMOVED useEffect(fetchFlights)
  ...
  const handleBookFlight = (flight: any) => {
    ...
    // flightSlice maps _id to id
    const id = flight.id || flight._id;
    dispatch(setFlightId(id));
    dispatch(setPrice(flight.price));

    navigate(`/booking/seat-selection?flight=${id}&price=${flight.price}`);
